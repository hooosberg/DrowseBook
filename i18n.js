...
(function () {
  ...
  const dict = {
    ...
    'en': {
      ...
      'hero.subtitle': 'Coming soon to the App Store',
    ...
    'ja': {
      ...
      'hero.subtitle': 'まもなく App Store にて配信',
