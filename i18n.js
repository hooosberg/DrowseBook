...
(function () {
  ...
  const dict = {
    'zh-Hans': {
      htmlLang: 'zh-Hans',
      'page.title': '入梦书 Drowsebook — 睡前听书 · 氛围伴读 · 一次买断',
      'nav.features': '功能',
      'nav.screenshots': '截图',
      'nav.privacy': '隐私',
      'nav.github': 'GitHub',
      'hero.title.l1': '睡前听书，氛围伴读',
      'hero.title.l2': '一次买断，永久使用',
      'hero.lede': '入梦书 是为睡前听书而生的 iPhone 应用。用 Apple 系统语音朗读你自己的书（EPUB / PDF / TXT / MOBI / AZW3），雨声、火炉、海浪、自然环境音相伴入眠。定时关闭、AirPods ±15 秒跳转。所有内容只在设备里——无账号，无服务器，无追踪。',
      'hero.subtitle': '一次买断 · One-time purchase, forever',
      'hero.cta.store': 'App Store · 立即下载',
      'hero.cta.github': '在 GitHub 上查看',
      'hero.meta.iphone': 'iPhone（iPad 通用待发布）',
      'hero.meta.ios': 'iOS 17 +',
      'hero.meta.onetime': '一次买断 $19.99',
      'hero.meta.noads': '无广告',
      ...
      'cta.title': '开始一段安静的阅读',
      'cta.body': '入梦书 已上架 App Store。一次买断 $19.99，无订阅，无广告。',
      'foot.app': '应用',
      'foot.legal': '法律',
      'foot.links': '链接',
      'foot.repo': 'GitHub',
      'foot.feedback': '反馈与建议',
      'foot.contact': '联系',
      'foot.tagline': '睡前听书 · 氛围伴读，一次买断永久使用',
    ...
    'zh-Hant': {
      htmlLang: 'zh-Hant',
      'page.title': '入夢書 Drowsebook — 睡前聽書 · 氛圍伴讀 · 一次買斷',
      'nav.features': '功能', 'nav.screenshots': '截圖', 'nav.privacy': '隱私', 'nav.github': 'GitHub',
      'hero.title.l1': '睡前聽書，氛圍伴讀',
      'hero.title.l2': '一次買斷，永久使用',
      'hero.lede': '入夢書 是為睡前聽書而生的 iPhone 應用。用 Apple 系統語音朗讀你自己的書（EPUB / PDF / TXT / MOBI / AZW3），雨聲、火爐、海浪、自然環境音相伴入眠。定時關閉、AirPods ±15 秒跳轉。所有內容只在裝置裡——無帳號，無伺服器，無追蹤。',
      'hero.subtitle': '一次買斷 · One-time purchase, forever',
      'hero.cta.store': 'App Store · 立即下載', 'hero.cta.github': '在 GitHub 上查看',
      'hero.meta.iphone': 'iPhone（iPad 通用版待發佈）', 'hero.meta.ios': 'iOS 17 +', 'hero.meta.onetime': '一次買斷 $19.99', 'hero.meta.noads': '無廣告', 'hero.meta.local': '本地儲存',
      'carousel.prev': '上一張', 'carousel.next': '下一張',
      'stat.formats': '種書籍格式', 'stat.langs': '種介面語言', 'stat.price': '一次買斷（美元）', 'stat.tracking': '追蹤 · 資料上傳',
    ...
    'en': {
      htmlLang: 'en',
      'page.title': 'Drowsebook — Bedtime listening with soft soundscapes, one-time purchase forever',
      'nav.features': 'Features', 'nav.screenshots': 'Screens', 'nav.privacy': 'Privacy', 'nav.github': 'GitHub',
      'hero.title.l1': 'Bedtime listening,',
      'hero.title.l2': 'soft soundscapes to fall asleep to.',
      'hero.lede': 'Drowsebook is an iPhone app built for bedtime listening. Hear your own books (EPUB, PDF, TXT, MOBI, AZW3) read aloud by Apple system voices, with rain, fireplace, ocean, and nature soundscapes layered underneath. Sleep timer with fade-out, AirPods ±15s skip. Everything stays on your device — no account, no server, no tracking.',
      'hero.subtitle': 'One-time purchase, forever',
      'hero.cta.store': 'Download on the App Store', 'hero.cta.github': 'View on GitHub',
      'hero.meta.iphone': 'iPhone (universal coming)', 'hero.meta.ios': 'iOS 17 +', 'hero.meta.onetime': '$19.99 one-time', 'hero.meta.noads': 'No ads', 'hero.meta.local': 'On-device only',
      'carousel.prev': 'Previous', 'carousel.next': 'Next',
      'stat.formats': 'book formats', 'stat.langs': 'UI languages', 'stat.price': 'one-time (USD)', 'stat.tracking': 'trackers · 0 uploads',
      ...
      'cta.body': 'Drowsebook is on the App Store: one-time $19.99, no subscription, no ads.',
      'foot.app': 'App', 'foot.legal': 'Legal', 'foot.links': 'Links', 'foot.repo': 'GitHub', 'foot.feedback': 'Feedback', 'foot.contact': 'Contact',
      'foot.tagline': 'Bedtime listening with soft soundscapes — one-time purchase, forever',
    ...
    'ja': {
      htmlLang: 'ja',
      'page.title': 'ドラウズブック Drowsebook — 寝る前の読み上げと環境音、一度きりの買い切り',
      'nav.features': '機能', 'nav.screenshots': '画面', 'nav.privacy': 'プライバシー', 'nav.github': 'GitHub',
      'hero.title.l1': '寝る前の読み上げに、',
      'hero.title.l2': 'やさしい環境音を重ねて。',
      'hero.lede': '入夢書 は、寝る前の読み上げのための iPhone アプリ。自分の本 (EPUB / PDF / TXT / MOBI / AZW3) を Apple のシステム音声で読み上げ、雨・暖炉・波・森・自然の環境音を下に重ねます。スリープタイマー（フェードアウト付き）、AirPods の ±15 秒スキップ。すべては端末の中だけ——アカウント不要、サーバーなし、追跡なし。',
      'hero.subtitle': '一度きりの買い切り · One-time purchase, forever',
      'hero.cta.store': 'App Store · 配信中', 'hero.cta.github': 'GitHub で見る',
      'hero.meta.iphone': 'iPhone（iPad ユニバーサル版予定）', 'hero.meta.ios': 'iOS 17 +', 'hero.meta.onetime': '買い切り $19.99', 'hero.meta.noads': '広告なし', 'hero.meta.local': '端末内保存',
      'carousel.prev': '前へ', 'carousel.next': '次へ',
      'stat.formats': '対応書式', 'stat.langs': 'UI 言語', 'stat.price': '買い切り（USD）', 'stat.tracking': '追跡 · 0 件',
